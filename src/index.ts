...
useApi({ api_path: '/', http_method: 'GET', description: 'Serve chat UI' }, handleServeUI)
useApi({ api_path: 'health', http_method: 'GET', description: 'Health check' }, handleHealth)
useApi({ api_path: 'sessions', http_method: 'GET', description: 'List sessions' }, handleListSessions)
useApi({ api_path: 'sessions', http_method: 'POST', description: 'Create session' }, handleCreateSession)
useApi({ api_path: 'sessions/chat', http_method: 'POST', description: 'Send message' }, handleSendMessage)
